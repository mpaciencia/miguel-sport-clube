"""
Django settings for miguelsc project.
...
SECRET_KEY = 'django-insecure-n2c15l01j+u(l_(ah0*4#^$^rcf39_efu0arl8cbieti@ec&dd'
...
WSGI_APPLICATION = 'miguelsc.wsgi.application'
